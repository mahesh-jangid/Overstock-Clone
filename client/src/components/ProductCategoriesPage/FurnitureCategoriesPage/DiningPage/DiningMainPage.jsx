...
import { addDiningProductData } from "./action";
        ...
        <div className="DiningMainContainer">
            ...
            <div className="DiningCategories__OfferBox">
                <div className="DiningCategories__Box">
                    <a href="/Furniture/Kitchen-Dining-Room-Sets">Kitchen & Dining Room Sets</a>
                    ...
                    <h5 style={{color : "red"}}>{<BsFillBookmarkFill />} Shop All Dining Room & Bar Furniture on Sale</h5>
                </div>
            ...
            <div className="Filtering__Grid-Container">
                ...
                <div className="Grid__Box">
                    {DiningData.map((element,index) => {
                        return (
                            <div key={index}>
                                    <a target={"_blank"} href={`/ProductDetails/Furniture/Dining-Room-&-Bar-Furniture/${element._id}`} style={{ textDecoration : "none"}}>
