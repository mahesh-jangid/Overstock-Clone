...
export const BedroomMainPage = () => {
  ...
  const LivingData = useSelector(
    (store) => store.FurnitureBedroomPage.bedroomdata
  );
  ...
  const sortData = () => {
    axios
      .get(`/Furniture/Bedroom-Furniture/${sorting}`)
  ...
  const getData = () => {
    axios
      .get("/Furniture/Bedroom-Furniture")
      // .then(res => setDiningMainData(res.data))
      .then((res) => {
        return dispatch(addBedroomProductData(res.data));
      })
    ...
    <div className="DiningMainContainer">
      ...
      <div className="DiningCategories__OfferBox">
        <div className="DiningCategories__Box">
          ...
          <h5 style={{ color: "red" }}>
            {<BsFillBookmarkFill />} Shop All Bedroom Furniture on Sale
          </h5>
        </div>
        ...
        <div className="DiningCategoriesOffer__Box">
          ...
          <div className="DiningCategoriesOffer__Lower-Banner">
            <img
              src="https://ak1.ostkcdn.com/img/mxc/12202021_2022Winter_BRFurn_AMOD.jpg?imwidth=1200&impolicy=custom"
              alt=""
            />
          </div>
        </div>
      ...
      <div className="ShopByCategory__Box">
        ...
        <div>
          <div>
            <div>
              <img
                src="https://ak1.ostkcdn.com/images/products/is/images/direct/b3f49865907eec83f1a24f7856d17c559c883c29/Giselle-Antique-Graceful-Dark-Bronze-Victorian-Iron-Bed-by-iNSPIRE-Q-Classic.jpg?imWidth=320&impolicy=medium"
                alt=""
              />
          ...
          <div>
            <div>
              <img
                src="https://ak1.ostkcdn.com/images/products/is/images/direct/b2f5ba19a79290f60aa76a1378c09fc849049dae/Novogratz-Kelly-6-Drawer-Dresser.jpg?imWidth=320&impolicy=medium"
                alt=""
              />
          ...
          <div>
            <div>
              <img
                src="https://ak1.ostkcdn.com/images/products/is/images/direct/0b23d2a580f970b6f81b61917d2e3c20e15202e6/Furniture-of-America-Inyx-Walnut-3-piece-Bedroom-Set-with-2-Nightstands.jpg?imWidth=320&impolicy=medium"
                alt=""
              />
          ...
          <div>
            <div>
              <img
                src="https://ak1.ostkcdn.com/images/products/is/images/direct/d97f071fb17e9bc2b887a4aa6eee0553ea2eb7eb/Picket-House-Furnishings-Brody-Side-Table-in-Grey.jpg?imWidth=320&impolicy=medium"
                alt=""
              />
          ...
          <div>
            <div>
              <img
                src="https://ak1.ostkcdn.com/images/products/is/images/direct/25948344a4a53d8a16a796ce01f547bc40bffc23/Brookside-Emmie-Adjustable-Upholstered-Headboard.jpg?imWidth=320&impolicy=medium"
                alt=""
              />
          ...
          <div>
            <div>
              <img
                src="https://ak1.ostkcdn.com/images/products/17783850/Melina-Tufted-Linen-Wingback-Bed-by-iNSPIRE-Q-Bold-d2f81d06-f240-4737-bb73-d94419a26a12_320.jpg?imWidth=320&impolicy=medium"
                alt=""
              />
      ...
      <div className="ShopByCategory__Box">
        ...
        <div>
          <div>
            <div>
              <img
                src="https://ak1.ostkcdn.com/img/mxc/BedroomSP_Icon_twinheadboard@3x.png?imWidth=320&impolicy=medium"
                alt=""
              />
          ...
          <div>
            <div>
              <img
                src="https://ak1.ostkcdn.com/img/mxc/BedroomSP_Icon_Fullheadboard@3x.png?imWidth=320&impolicy=medium"
                alt=""
              />
          ...
          <div>
            <div>
              <img
                src="https://ak1.ostkcdn.com/img/mxc/BedroomSP_Icon_Queenheadboard@3x.png?imWidth=320&impolicy=medium"
                alt=""
              />
          ...
          <div>
            <div>
              <img
                src="https://ak1.ostkcdn.com/img/mxc/BedroomSP_Icon_Kingheadboard@3x.png?imWidth=320&impolicy=medium"
                alt=""
              />
          ...
          <div>
            <div>
              <img
                src="https://ak1.ostkcdn.com/img/mxc/BedroomSP_Icon_CalKingheadboard@3x.png?imWidth=320&impolicy=medium"
                alt=""
              />
          ...
          {LivingData.map((element, index) => {
            return (
              <div key={index}>
                <a
                  target={"_blank"}
                  href={`/ProductDetails/Furniture/Bedroom-Furniture/${element._id}`}
