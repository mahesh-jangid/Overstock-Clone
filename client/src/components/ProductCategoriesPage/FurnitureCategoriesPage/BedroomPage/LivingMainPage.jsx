...
export const BedroomMainPage = () => {
    ...
    const handleCart = async (object) => {
        ...
        fetch("https://agile-woodland-69576.herokuapp.com/cart/tobedroompage")
        .then((res) => {
            return res.json()
        })
        .then((res) => {
    ...
    // }
    const sortData = () => {
        axios.get(`https://agile-woodland-69576.herokuapp.com/Furniture/Bedroom-Furniture/${sorting}`)
    ...
    const getData = () => {
        axios.get("https://agile-woodland-69576.herokuapp.com/Furniture/Bedroom-Furniture")
        // .then(res => setDiningMainData(res.data))
        .then(res => {
            return dispatch(addBedroomProductData(res.data))
        })
