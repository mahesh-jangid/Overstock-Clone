       ...
       <div className="sliders">
         <div className="slider1">
           <div>
             <img
               id="productImage"
               src="https://ak1.ostkcdn.com/images/products/is/images/direct/40589834cb760419da0f59d5a823431a930324d2/Monsoon-Villa-Faux-Leather-Parson-Dining-Chairs-%28Set-of-2%29.jpg?imwidth=320&impolicy=medium"
               alt=""
             />
           </div>
           <button
              ...
              <div id="iconsSlides">
                <div className="iconSlides">
                  <div className="active">
                    <img src="https://ak1.ostkcdn.com/images/products/is/images/direct/92a6d3a0ba3b6b9e219d7d72e516f5b62347e4fd/Monsoon-Villa-Faux-Leather-Parson-Dining-Chairs-%28Set-of-2%29.jpg" alt="" id="img1p" />
                  </div>
                  <div>
                    <img src="" alt="" id="img2p" />
                  </div>
                  <div>
                    <img src="" alt="" id="img3p" />
                  </div>
                  <div>
                    <img src="" alt="" id="img4p" />
                  </div>
                  <div>
                    <img src="" alt="" id="img5p" />
                  </div>
                  <div>
                    <img src="" alt="" id="img6p" />
                  </div>
                </div>
              </div>
              <div></div>
          ...
          <div className="item-info">
            <div>
              <p id="productName1" className="title">
                Candace Mid-century Modern Fabric Loveseat by Christopher Knight
                Home - mocha
                {/* {data.title} */}
              </p>
                ...
                <div>
                  <div className="frame-img2">
                    <div className="frame-image2">
                      <img src="https://ak1.ostkcdn.com/images/products/is/images/direct/40589834cb760419da0f59d5a823431a930324d2/Monsoon-Villa-Faux-Leather-Parson-Dining-Chairs-%28Set-of-2%29.jpg?imwidth=320&impolicy=medium" alt="" id="colorImg1" />
                    </div>
                  </div>
                  <div>
                    <p id="colorName1"></p>
